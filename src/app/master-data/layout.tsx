...
// operational screens — Overview/Projects/Timeline/People/Squads — that read
// this same data).
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        <p className="max-w-2xl text-sm text-muted-foreground">
          ...
          planning, use Overview, Projects, Timeline, People, or Squads instead — those stay in sync
