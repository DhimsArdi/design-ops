...
// `navButtonSize: "default"` maps to this app's `md` (40px) rather than
// shadcn's stock `default` — Button's size scale here is xs/sm/md/lg, with md
// as the standardized default (docs/CHANGELOG.md, "Button size system
// standardized on 40px").
function useNavButtonProps(): {
  ...
  return {
    ...
    size: viewConfig.navButtonSize === "sm" ? "sm" : "md",
