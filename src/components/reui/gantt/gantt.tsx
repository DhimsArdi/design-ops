...
interface GanttViewConfig<TData = unknown> {
  ...
  /**
   * Replaces the bar's hover tooltip CONTENT (title + range by default); the
   * tooltip shell, its hover-only open policy and its suppression during a
   * gesture stay gantt-owned. Return null to give a bar no tooltip.
   */
  renderEventTooltip?: (props: GanttRenderEventProps<TData>) => ReactNode
  /**
